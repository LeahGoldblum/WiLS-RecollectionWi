        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <Link to="/organizations" className="border border-neutral-300 bg-neutral-50 p-6 hover:shadow-md hover:border-neutral-500 hover:bg-white transition-all">
              ...
              <Link to="/organizations/resources" className="border border-neutral-300 bg-neutral-50 p-6 hover:shadow-md hover:border-neutral-500 hover:bg-white transition-all">
                <div className="flex flex-col items-center text-center gap-4">
                  <div className="w-16 h-16 border border-neutral-300 bg-white flex items-center justify-center">
              ...
              <Link to="/organizations/get-started" className="border border-neutral-300 bg-neutral-50 p-6 hover:shadow-md hover:border-neutral-500 hover:bg-white transition-all">
                <div className="flex flex-col items-center text-center gap-4">
                  <div className="w-16 h-16 border border-neutral-300 bg-white flex items-center justify-center">
