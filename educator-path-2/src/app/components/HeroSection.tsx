      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
          ...
          <Link
            ...
            className="border-2 border-neutral-400 bg-white p-6 md:p-8 cursor-pointer transition-all hover:shadow-md hover:border-neutral-600 block"
          >
          ...
          >
            <div className="flex flex-col items-center text-center gap-4 md:gap-6">
              ...
              <p className="font-mono text-base md:text-lg text-neutral-700">
                I want to research family history.
              </p>
              {hoveredCard === 2 && (
                <span className="font-mono text-xs text-neutral-500 bg-neutral-100 px-3 py-1 border border-neutral-300">
                  Click to explore →
