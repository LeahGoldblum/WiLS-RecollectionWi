  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="relative">
        ...
        <Annotation
          number={5}
          text="Contributor CTA section with subtle card styling and hover highlights improves visibility for contributor organizations without overwhelming general audiences."
          position="right"
        />
      </div>
