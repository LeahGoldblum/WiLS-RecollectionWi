    ...
    items: [
      {
        ...
        a: 'Yes. Your organization retains full ownership and copyright of your original materials. Contributing to Recollection Wisconsin does not transfer ownership or copyright to RW or WiLS. You grant RW a non-exclusive license to display and aggregate your materials for public access.',
      },
      {
      ...
      },
      {
        ...
        a: 'You can indicate "unsure" during the intake process — there\'s no penalty for uncertainty. A WiLS staff member will review your situation and help you navigate rights assessment. We recommend reviewing the RightsStatements.org vocabulary before your discovery call.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'RW runs harvests on a quarterly schedule — approximately every three months. This means new items, updated metadata, or removed items may take up to 3 months to be reflected in the RW portal and DPLA. If you need a specific publication date, plan your submission accordingly.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'A WiLS/RW staff member will review your submission and follow up by email to schedule a discovery call. This call helps us confirm pathway fit, discuss technical requirements, and plan next steps. No commitment is made at the wizard stage.',
      },
    ],
  },
];
          ...
          <div className="max-w-3xl mx-auto space-y-10">
            ...
            <div className="border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="text-sm text-neutral-600 mb-5 leading-relaxed">
                The Get Started wizard is designed to work even if you're not sure which pathway fits or whether you meet requirements. You can answer "unsure" for any technical question — no dead ends. A WiLS staff member reviews every submission personally.
              </p>
