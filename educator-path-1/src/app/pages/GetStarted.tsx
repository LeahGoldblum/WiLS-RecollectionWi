    ...
    <div className="space-y-6">
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        ...
        <div>
          ...
          <p className="text-xs text-neutral-500 mt-0.5">e.g. Indigenous communities, immigrant communities, LGBTQ+ history, communities of color, rural communities. RW prioritizes these collections; we can discuss more how the digital materials and metadata are handled.</p>
        </div>
      </label>
    </div>
  );
      ...
      <div>
        ...
        <label className={`flex items-start gap-3 p-4 border cursor-pointer transition-colors ${
          ...
          <span className="text-sm text-neutral-800 leading-relaxed">
            ...
            <a href="https://creativecommons.org/public-domain/cc0/" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-600">What is CC0?</a>
          </span>
        </label>
      </div>
