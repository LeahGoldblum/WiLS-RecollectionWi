            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {EXHIBITS.map((exhibit) => (
                ...
                >
                  ...
                  <div className="h-36 bg-neutral-100 border-b border-neutral-200 flex items-center justify-center flex-shrink-0">
                    <div className="text-center">
                      <div className="w-10 h-10 border border-neutral-300 bg-neutral-50 mx-auto mb-2 flex items-center justify-center">
                        <span className="text-neutral-400 font-mono text-xs">[img]</span>
                      </div>
                      <p className="text-xs font-mono text-neutral-400">Thumbnail placeholder</p>
                    </div>
                  </div>
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="mt-4 pt-4 border-t border-neutral-100 flex items-center justify-between">
                      <button className="inline-flex items-center gap-1.5 text-sm text-neutral-700 hover:text-neutral-900 hover:underline transition-colors">
                        <ExternalLink className="w-3.5 h-3.5" />
                        Open exhibit
                      </button>
                      <span className="text-xs font-mono text-neutral-400 italic">[stub link]</span>
                    </div>
                  </div>
                </div>
              ))}
