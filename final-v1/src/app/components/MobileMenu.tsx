...
const resourceColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Get Started Help', href: '/contribute/get-started' },
    ],
  },
  {
    heading: 'Guides',
...
export function MobileMenu({ isOpen, onClose, previewContent }: MobileMenuProps) {
  ...
  const sections = [
    { key: 'explore', label: 'Explore', content: previewContent.explore },
    { key: 'educators', label: 'For Educators', content: previewContent.educators },
    { key: 'genealogists', label: 'Genealogists', content: previewContent.genealogists },
    { key: 'contribute', label: 'Contribute', content: previewContent.contribute },
