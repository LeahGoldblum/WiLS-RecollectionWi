      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto space-y-10">
            ...
            {/* Harvest cadence callout */}
            <div className="border border-neutral-300 bg-neutral-50 p-5">
              <div className="flex items-start gap-3">
                <Clock className="w-5 h-5 text-neutral-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="text-sm font-semibold text-neutral-800 mb-1">Harvest cadence: every three months</h3>
                  <p className="text-sm text-neutral-600 leading-relaxed">
                    RW runs harvests <strong>every three months</strong>. This means changes you make to your collection — new items, updated metadata, removed items — may take <strong>up to three months</strong> to appear in or be removed from the RW portal and DPLA. Plan your onboarding and updates accordingly.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  'You can accept that updates may appear within an every-three-month harvest cycle',
                ].map(item => (
            ...
            <div>
              ...
              <div className="border border-neutral-200 divide-y divide-neutral-100">
                {[
                  ...
                  <div key={item.label} className="flex flex-col sm:flex-row gap-2 sm:gap-4 px-4 py-3">
                    <span className="text-sm font-medium text-neutral-800 sm:w-44 flex-shrink-0">{item.label}</span>
            ...
            <div className="border border-neutral-200 bg-neutral-50 p-5 flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-neutral-700 mb-2">
                  Not sure if you have an OAI-PMH endpoint? That's OK. You can indicate "unsure" in the wizard and a Recollection Wisconsin staff member will help assess your readiness.
                </p>
                <div className="flex gap-3 flex-wrap">
                  <Link to="/contribute/hosting" className="text-sm text-neutral-700 hover:underline">Compare with Hosting →</Link>
                  <Link to="/contribute/contributor-faq" className="text-sm text-neutral-700 hover:underline">Read the FAQ →</Link>
                </div>
              </div>
            </div>
          </div>
