...
type Pathway = 'hosting' | 'harvesting' | 'rwdi' | '';
      ...
      <div>
        ...
        <RadioGroup
          ...
          options={[
            ...
            { value: 'digitize', label: 'Get help digitizing undigitized materials', hint: 'You have physical items you\'d like to scan and share.' },
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <PathwayCard
          ...
          bullets={['You already have a digital repository', 'Your platform supports OAI-PMH', 'Quarterly harvest cadence (~3 months)']}
          selected={data.pathway === 'harvesting'}
          onSelect={() => setData({ ...data, pathway: 'harvesting' })}
        />
        <PathwayCard
          id="rwdi"
          title="RW Digitization Initiative"
          desc="For organizations with undigitized physical collections."
          bullets={['Materials are not yet digitized', 'Competitive selection process', 'Focus on underrepresented Wisconsin stories']}
          selected={data.pathway === 'rwdi'}
          onSelect={() => setData({ ...data, pathway: 'rwdi' })}
        />
      </div>
    ...
    <div className="space-y-6">
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        ...
        <div>
          ...
          <p className="text-xs text-neutral-500 mt-0.5">e.g. Indigenous communities, immigrant communities, LGBTQ+ history, communities of color, rural communities. RW prioritizes these collections for the Digitization Initiative.</p>
        </div>
      </label>
    </div>
  );
      ...
      <div>
        ...
        <RadioGroup
          ...
          options={[
            ...
            { value: 'unsure', label: 'Unsure — we need to assess rights status', hint: 'That\'s OK. A WiLS staff member can help guide your rights assessment.' },
        ...
        <div>
          ...
          {(data.pathway === 'harvesting' && data.hasOaiPmh === 'unsure') && (
            <div className="mt-3 border border-neutral-200 bg-neutral-50 p-4 flex items-start gap-3">
              <Info className="w-4 h-4 text-neutral-500 flex-shrink-0 mt-0.5" />
              <p className="text-sm text-neutral-600">No problem. A WiLS staff member can help you assess OAI-PMH readiness after you submit.</p>
            </div>
          )}
        </div>
      )}
    ...
    <div className="space-y-6">
      ...
      {data.pathway === 'harvesting' && (
        <div className="border border-neutral-200 bg-neutral-50 p-4 flex items-start gap-3">
          ...
          <p className="text-sm text-neutral-700">
            <strong>Harvesting reminder:</strong> RW runs harvests quarterly (~every 3 months). New items added after an initial harvest may take up to 3 months to appear in the RW portal and DPLA.
          </p>
        </div>
      )}
...
function Step7({ data, goToStep, onSubmit, submitting }: { data: WizardData; goToStep: (s: number) => void; onSubmit: () => void; submitting: boolean }) {
  const pathwayLabel = { hosting: 'Hosting', harvesting: 'Harvesting', rwdi: 'RW Digitization Initiative', '': 'Not selected' };
  return (
    <div className="space-y-6">
      <div>
...
export function GetStarted() {
  ...
  const handleSubmit = () => {
    setSubmitting(true);
    setTimeout(() => {
      navigate('/organizations/confirmation', { state: { pathway: data.pathway, orgName: data.orgName, contactEmail: data.contactEmail } });
    }, 1200);
  };
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 md:px-6 py-10 md:py-14">
          <div className="max-w-2xl mx-auto">
            ...
            {step === 7 && <Step7 data={data} goToStep={setStep} onSubmit={handleSubmit} submitting={submitting} />}
