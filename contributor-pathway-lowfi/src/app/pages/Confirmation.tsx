...
const nextSteps: Record<NonNullable<Pathway>, string[]> = {
  hosting: [
    'A WiLS/RW staff member will review your intake and follow up within 2–4 weeks.',
  ...
  harvesting: [
    ...
    'Your collection will be added to the quarterly harvest schedule.',
    'Expect initial publication within one harvest cycle (~3 months after setup is complete).',
  ],
  rwdi: [
    'A WiLS/RW staff member will review your expression of interest within 2–4 weeks.',
    'Selections for the Digitization Initiative are competitive and reviewed periodically.',
    'We\'ll contact you to discuss eligibility and collection priorities.',
    'If selected, RW will coordinate scanning, metadata creation, and publication.',
    'You\'ll retain ownership of all materials throughout the process.',
  ],
  '': [
    'A WiLS/RW staff member will review your intake and follow up within 2–4 weeks.',
...
const pathwayLabels: Record<string, string> = {
  ...
  rwdi: 'RW Digitization Initiative',
  '': 'Intake Submitted',
};

export function Confirmation() {
  const location = useLocation();
  const state = location.state as { pathway?: Pathway; orgName?: string; contactEmail?: string } | null;
          ...
          <div className="border border-neutral-200 bg-neutral-50 p-8 mb-8 text-center">
            ...
            {contactEmail && (
              <p className="text-sm text-neutral-500">
                A copy of this submission will be sent to <strong>{contactEmail}</strong>.
              </p>
            )}
          ...
          {pathway === 'harvesting' && (
            <div className="border border-neutral-200 bg-neutral-50 p-4 mb-8 flex items-start gap-3">
              ...
              <p className="text-sm text-neutral-600">
                <strong>Harvesting reminder:</strong> RW runs harvests quarterly. After your OAI-PMH connection is configured, your items may take up to approximately 3 months to appear in the RW portal and DPLA.
              </p>
            </div>
          )}
